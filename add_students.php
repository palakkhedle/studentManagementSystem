...
<body>
    ...
    <div class="title">
        <a href="dashboard.php"><img src="./images/lgm.gif" alt="" class="logo"></a>
        <span class="heading">Dashboard</span>
        <a href="logout.php" style="color: rgb(250, 228, 26)"><span class="fa fa-sign-out fa-2x">Logout</span></a>
    </div>
